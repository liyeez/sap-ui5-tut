...
const $ = Object.assign, $$ = (o,p,v) => Object.defineProperty(o,p,{value:v})
...
function _options4 (src, ...mappings) {
  ...
  const dst = $$({__proto__:src},_4cdsc,true) // NOTE: {__proto__:src} not possible due to compiler obviously cloning options
...
module.exports = exports = {__proto__:compile, _options,
  ...
  to: {__proto__: compile.to,
    edmx: $((csn,o) => compile.to.edmx (csn, _options.for.edm(o)), {
      all: (csn,o) => compile.to.edmx.all (csn, _options.for.edm(o))
    }),
    edm: $((csn,o) => compile.to.edm (csn, _options.for.edm(o)), {
      all: (csn,o) => compile.to.edm.all (csn, _options.for.edm(o))
    }),
    hdi: $((csn,o) => compile.to.hdi (csn, _options.for.hana(o)), {
      migration: (csn,o,...etc) => {
        o = $({...o},_options.for.hana(o)) //> REVISIT: need to flatten as compiler seems to clone options in that impl
